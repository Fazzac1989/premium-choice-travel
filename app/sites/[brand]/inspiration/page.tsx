...
export const metadata = {
  ...
  description:
    'Answer a few questions and our AI holiday curator sketches three tailor-made trip ideas — then a Premium Choice Holidays specialist prices the one you love.',
};
